...
public interface UserDao {
    //Nhóm các hàm CRUD
    int insertUser(User user); //Thêm một user mới

    User getUserById(int id); //Lấy thoong tin user theo id
    ...
    boolean isEmailExists(String email); //Kiểm tra xem email này có đã tồn tại chuwa
}
